...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UnnostroTe.croppingfree'
        db.delete_column(u'website_unnostrote', 'croppingfree')


    def backwards(self, orm):
        # Adding field 'UnnostroTe.croppingfree'
        db.add_column(u'website_unnostrote', 'croppingfree',
